...
async function run() {
  ...
  console.log('Uploading real PNG as "logo"...');
  const uploadForm = new FormData();
  uploadForm.append('logo', fileBlob, 'logo-dark.png');
  ...
  console.log('User Avatar URL:', uploadData.data?.avatar);
  console.log('Company Profile Logo URL:', uploadData.data?.companyProfile?.logoUrl);
}
